                        ...
                        <div className="profile">
                            ...
                            {curriculumData.map((curriculum) => {
                                return curriculum.foto != null ? (
                                    ...
                                    <img className="profileImg" src={profilePhoto} style={{
                                        width: '170px',
                                        height: '170px',
                                        borderRadius: '50%',
                                        objectFit: 'cover',
                                ...
                                <div style={{ marginTop: "85px" }}>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column" }}>
                                        {curriculumData.linguaMadre !== "" ? (
                                            curriculumData.map((curriculum) => (
                                                <div style={{ display: "flex", flexDirection: "row" }}><p class="lingue">{curriculum.linguaMadre}</p><p class="lingue" style={{ marginRight: "20px" }}>(madrelingua)</p></div>
                                            ))) : (<div></div>)}
