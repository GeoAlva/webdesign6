                            ...
                            {curriculumData.map((curriculum) => ( 
                                ...
                                <div className="dataContainer">
                                    ...
                                    {curriculumData.altroSocial1 != "" ? (
                                            <div style={{ display: "flex", flexDirection: "row" }}><p class="utilsDescription" style={{ marginRight: "10px" }}>{curriculum.altroSocial1} / {curriculum.accountSocial1}</p></div>
                                        ) : (<div></div>)}
                                    {curriculumData.altroSocial2 != "" ? (
                                        curriculumData.map((curriculum) => (
                                            <div style={{ display: "flex", flexDirection: "row" }}><p class="utilsDescription" style={{ marginRight: "10px" }}>{curriculum.altroSocial2} / {curriculum.accountSocial2}</p></div>
                                        ))) : (<div></div>)}
                                    {curriculumData.altroSocial3 != "" ? (
                                        curriculumData.map((curriculum) => (
                                            <div style={{ display: "flex", flexDirection: "row" }}><p class="utilsDescription" style={{ marginRight: "10px" }}>{curriculum.altroSocial3} / {curriculum.accountSocial3}</p></div>
                                        ))) : (<div></div>)}
                                    {curriculumData.altroSocial4 != "" ? (
                                        curriculumData.map((curriculum) => (
                                            <div style={{ display: "flex", flexDirection: "row" }}><p class="utilsDescription" style={{ marginRight: "10px" }}>{curriculum.altroSocial4} / {curriculum.accountSocial4}</p></div>
                                        ))) : (<div></div>)}
                                            ...
                                            curriculum.esp1 === "Sì" ? (
                                                <div class="maturità">
                                                    ...
                                                    <p class="titolino">{curriculum.mansione1} {curriculumData.map((curriculum) =>
                                                        curriculum.fineLavoro1 == null ? (<span style={{ float: "right" }}>da {curriculum.inizioLavoro1}</span>) : (<span style={{ float: "right" }}>{curriculum.inizioLavoro1} - {curriculum.fineLavoro1}</span>))}</p>
                                        ...
                                        {curriculumData.espExtra1 = "Sì" ? (
                                            curriculumData.map((curriculum) => (
                                                <div class="maturità">
                                                    ...
                                                    <p class="titolino">{curriculum.tipoExtra1} <span style={{ float: "right" }}>{curriculum.periodoExtra1}</span></p>
                                        ...
                                        {curriculumData.espExtra2 = "Sì" ? (
                                            curriculumData.map((curriculum) => (
                                                <div class="maturità">
                                                    ...
                                                    <p class="titolino">{curriculum.tipoExtra2} <span style={{ float: "right" }}>{curriculum.periodoExtra2}</span></p>
                                        ...
                                        {curriculumData.espExtra3 = "Sì" ? (
                                            curriculumData.map((curriculum) => (
                                                <div class="maturità">
                                                    ...
                                                    <p class="titolino">{curriculum.tipoExtra3} <span style={{ float: "right" }}>{curriculum.periodoExtra3}</span></p>
                                        ...
                                        {curriculumData.espExtra4 = "Sì" ? (
                                            curriculumData.map((curriculum) => (
                                                <div class="maturità">
                                                    ...
                                                    <p class="titolino">{curriculum.tipoExtra4} <span style={{ float: "right" }}>{curriculum.periodoExtra4}</span></p>
